	...
	<div id="main">
		...
		<div class="admin-content" id="main-right">
			<div class="listbiaoti am-cf">
				<ul class="am-icon-flag on">退货订单</ul>
				<dl class="am-icon-home" style="float: right;">当前位置： 客户服务中心 ><a href="#">售后管理</a> ><a href="#">退货订单</a></dl>
			</div>
			<h2>添加退货单</h2><br /><br />
			<form action="<%=request.getContextPath()%>/insertorderform.action"
				...
				<table class="am-table-bordered am-table-radius am-table-striped am-table-hover">
					...
					<tr>
						<td>订购数量</td>
						<td>
							<input type="text" name="amount" id="amount" value="${orderForm.shopNum}"/>
						</td>
					</tr>
					<tr>
						<td>换货数量</td>
					...
					<tr>
						...
						<td>
							...
							<input type="text" name="orderTypeName" value="退货" />
						</td>
					</tr>
					<tr>
						<td>送货地址</td>
					...
					<tr>
						<td colspan="2">
							<input type="submit" id="submit" value="退货" class="button-style"/>
						</td>
					</tr>
					<tr>
						<td colspan="2">
