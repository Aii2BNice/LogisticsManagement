	...
	<div id="main">
		...
		<div class="admin-content" id="main-right">
			<div class="listbiaoti am-cf">
				<ul class="am-icon-flag on">修改用户</ul>
				<dl class="am-icon-home" style="float: right;">当前位置： 系统管理 ><a href="#">用户管理</a> ><a href="#">修改用户</a></dl>
			</div>
			<h2>修改用户</h2><br /><br />
			<form action="<%=request.getContextPath()%>/updateuser.action"
				method="post">
				<table class="am-table-bordered am-table-radius am-table-striped am-table-hover">
					<tr>
						<td>用户名:</td>
						<td>
							<input type="text" name="uname" readonly="readonly" value="${uname}"/>
						</td>
					</tr>
					<tr>
						<td>密码:</td>
