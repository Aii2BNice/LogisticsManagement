...
public class ClientController {
	...
	public String insert(HttpServletRequest req, Client client) {
		...
		try{
			...
			journalService.insert(new Journal(null, "su", null, null, null, null, "添加客户"));
		}catch(Exception e){
			count = 0;
		}
		if(count>0){
	...
	public String update(HttpServletRequest req, Client client) {
		...
		try{
			...
			journalService.insert(new Journal(null, "su", null, null, null, null, "修改客户"));
		}catch(Exception e){
			count = 0;
		}
		if(count>0){
	...
	public String delete(HttpServletRequest req, Integer clientId) {
		...
		if(orders.size()>0){
			...
			try{
				...
				journalService.insert(new Journal(null, "su", null, null, null, null, "删除客户"));
			}catch(Exception e){
				count = 0;
			}
		}
