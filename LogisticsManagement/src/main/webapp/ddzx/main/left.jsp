	...
	<div id="main">
		...
		<div class="main-left">
			<div
				...
				<span style="margin-left: 5px;">调度中心管理</span>
			</div>
			...
			<div class="sideMenu">
				...
				<ul>
					<li><a href="<%=request.getContextPath()%>/orderformquerybystateid.action?orderStateId=1" target="right2">订单查询</a></li>
				</ul>
				<h3>
					<em></em><a href="#">自动调度</a>
				</h3>
				<ul>
					<li><a href="<%=request.getContextPath()%>/ddzx/zddd/orderzddd.jsp" target="right2">可自动调度订单查询</a></li>
				</ul>
				<h3>
					<em></em><a href="#">任务单</a>
				</h3>
				<ul>
					<li><a href="<%=request.getContextPath()%>/rwdcc.action" target="right2">任务单查询</a></li>
				</ul>
				<h3>
					<em></em><a href="#">缺货订单</a>
				</h3>
				<ul>
					<li><a href="<%=request.getContextPath()%>/querybyyrk.action" target="right2">查看已到货订单</a></li>
				</ul>
				<h3>
					<em></em><a href="#">系统设置</a>
				</h3>
