...
<div class="admin-biaogelist">
	...
	<form class="am-g" action="<%=request.getContextPath()%>/invoicecxsubby.action" method="post">
		<table width="90%" class="am-table-bordered am-table-radius am-table-striped am-table-hover"> <!-- class="am-table am-table-bordered am-table-radius am-table-striped am-table-hover" -->
			...
			<tr>
				...
				<td>登记日期</td>
				<td>
					<input type="date" name="registerDate" />(可选填)
				</td>
				</tr>
			<tr>
				<td>操作
		...
		<table width="90%" class="am-table-bordered am-table-radius am-table-striped am-table-hover">
			...
			<c:forEach items="${list}" var="u">
				<tr>
					...
					<td><a class="am-btn am-btn-default am-btn-xs am-text-success am-round" href="<%=request.getContextPath() %>/invoicecxsubbyid.action?id=${u.id}"><span class="am-icon-search" title="分站领用">分站领用</span></a></td>
				</tr>
