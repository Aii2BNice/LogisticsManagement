	...
	<div id="main">
		...
		<div class="main-left">
			<div
				...
				<span style="margin-left: 5px;">仓库管理</span>
			</div>
			...
			<div class="sideMenu">
				...
				<h3>
					<em></em><a href="javascript:;">单据管理</a>
				</h3>
				<ul>
					<li><a href="<%=request.getContextPath()%>/depotmanage/selectforms/queryforms.jsp" target="right">单据查询</a></li>
				</ul>
				<h3>
					<em></em><a href="javascript:;">商品管理</a>
				</h3>
				<ul>
					<li><a href="<%=request.getContextPath()%>/depotmanage/shopstock/queryshopstock.jsp" target="right">库存商品查询</a></li>
				</ul>
				<h3>
