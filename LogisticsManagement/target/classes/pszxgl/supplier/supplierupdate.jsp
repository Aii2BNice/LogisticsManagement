...
<div class="admin-biaogelist">
	...
	<form class="am-g" action="<%=request.getContextPath()%>/updateSupplier.action?act=update" method="post">
		<table width="90%" class="am-table-bordered am-table-radius am-table-striped am-table-hover">
			...
			<tr>
				<td>供应商名称:</td>
				<td><input type="text" name="name" value="${sup.name}" required="required"/></td>
			</tr>
			<tr>
				<td>地址:</td>
				<td><input type="text" name="address" value="${sup.address}" required="required"/></td>
			</tr>
			<tr>
				<td>联系人:</td>
				<td><input type="text" name="contactName" value="${sup.contactName}" required="required"/></td>
			</tr>
			<tr>
				<td>联系电话:</td>
				<td><input type="text" name="contactPhone" value="${sup.contactPhone}" required="required"/></td>
			</tr>
			<tr>
				<td>开户银行:</td>
				<td><input type="text" name="openingBank" value="${sup.openingBank}" required="required"/></td>
			</tr>
			<tr>
				<td>银行账号 :</td>
				<td><input type="text" name="accountNumber" value="${sup.accountNumber}" required="required"/></td>
			</tr>
			<tr>
				<td>传真:</td>
				<td><input type="text" name="fax" value="${sup.fax}" required="required"/></td>
			</tr>
			<tr>
				<td>邮编 :</td>
				<td><input type="text" name="postcode" value="${sup.postcode}" required="required"/></td>
			</tr>
			<tr>
				<td>法人:</td>
				<td><input type="text" name="artificalPerson" value="${sup.artificalPerson}" required="required"/></td>
			</tr>
			<tr>
				<td>备注:</td>
